...
function GlobeComponent({
  ...
  // Load and initialize ThreeGlobe
  useEffect(() => {
  ...
  // Configure globe when instance is available
  useEffect(() => {
  ...
  }, [globeInstance, data, globeConfig, defaultProps]);
  ...
  return <primitive object={globeInstance} ref={globeRef} />;
}
